...
def load_character_as_pixmap(face_type : FaceType) -> QPixmap:
    ...
    match face_type:
        case FaceType.Closed:
            pixmap = QPixmap("app/assets/character_1.png")
        case FaceType.HalfOpen:
            pixmap = QPixmap("app/assets/character_5.png")
        case FaceType.LeftOpen:
            pixmap = QPixmap("app/assets/character_2.png")
        case FaceType.RightOpen:
            pixmap = QPixmap("app/assets/character_3.png")
        case FaceType.Open:
            pixmap = QPixmap("app/assets/character_4.png")
        case _:
